...
import sys
sys.path.append("../")
from easynlp import textRankPlus4KeyWord
...
#获取排序的关键词排序结果写入文件
sorted_words = textRankPlus4KeyWord.get_sort_keyword(raw_text)
print(sorted_words)



#获取关键句排序结果并些如文件
sorted_sentence = textRankPlus4KeySentence.get_sort_sentences(raw_text)
textRankPlus4KeySentence.keyword_to_csv_file("data/out_sentences.csv", sorted_sentence)
